...
public class Templates {
    ...
    static {
        ...
        dynamicReportsComponent = cmp.horizontalList(cmp.image(Templates.class.getResource("")).setFixedDimension(60, 60),
                                                     cmp.verticalList(cmp.text("DynamicReports").setStyle(bold22CenteredStyle).setHorizontalTextAlignment(HorizontalTextAlignment.LEFT),
                                                                      cmp.text("").setStyle(italicStyle).setHyperLink(link))).setFixedWidth(300);
